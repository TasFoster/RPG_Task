...
abstract class AppLocalizations {
  ...
  /// No description provided for @onboardSkillsTitle.
  ///
  /// In ru, this message translates to:
  /// **'Роза навыков'**
  String get onboardSkillsTitle;

  /// No description provided for @onboardSkillsBody.
  ///
  /// In ru, this message translates to:
  /// **'Прокачивайте оси навыков — здоровье, спорт, учёбу и другие. Выполненные дела растят вашего героя.'**
  String get onboardSkillsBody;

  /// No description provided for @onboardBossTitle.
  ///
  /// In ru, this message translates to:
  /// **'Победите боссов'**
  String get onboardBossTitle;

  /// No description provided for @onboardBossBody.
  ///
  /// In ru, this message translates to:
