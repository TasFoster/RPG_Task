    ...
    return Scaffold(
      ...
      body: questsAsync.when(
        ...
        data: (quests) => ListView(
          ...
          children: [
            for (final v in quests) _QuestCard(view: v),
          ],
        ),
      ),
    );
...
class _QuestCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final q = view.quest;
    final frac = (view.progress / q.target).clamp(0.0, 1.0);
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(QuestsScreen._icon(q.type), color: theme.colorScheme.primary),
                const SizedBox(width: 8),
                Expanded(
                  child: Text(QuestsScreen._title(q.type),
                      style: theme.textTheme.titleMedium),
                ),
                Text('+${q.rewardXp} XP · +${q.rewardGold}💰',
